...
extern mmcCardInfo sdCard;       // SD card info struc
...
// Function prototypes
extern unsigned int MMCReadCmdSend(mmcCtrlInfo *ctrl, void *ptr, 
                                   unsigned int block, unsigned int blks);
extern unsigned int MMCWriteCmdSend(mmcCtrlInfo *ctrl, void *ptr, 
                                    unsigned int block, unsigned int blks);
...
extern void mmc0_config(void);
extern void mmc0_dma_config(void);
extern void mmc0_start(void);
